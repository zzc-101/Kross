...
- [ ] **Step 1: 抽出 conductor plan 类型到 modes**
...
- [ ] **Step 2: 新建 pendingExecution，并从 agentRuntimeTypes 迁出**
...
- [ ] **Step 3: 移动 `createDefaultSubagentRunner` 到 subagentRunner.ts**
...
- [ ] **Step 1: 把 createRuntime 逻辑原样迁到 core host**
...
- [ ] **Step 1: 写 completeToolLoop 失败测试（TDD）**
...
- [ ] **Step 3: 实现 shared + completeToolLoop**
...
- [ ] **Step 4: subagentRunner 改为调用 completeToolLoop**
