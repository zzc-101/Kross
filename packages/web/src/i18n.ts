  ...
  'zh-CN': {
    translation: {
      ...
      session: {
        ...
        agentMode: 'Agent 模式',
        thinkingEffort: '思考强度',
        modelAndThinking: '模型与思考强度',
        selectConfiguredModel: '选择模型',
        noConfiguredModels: '尚未配置模型',
        gatewayModels: 'Gateway 提供',
        workspaceModels: '当前工作区',
        capabilities: '当前模型能力',
        capabilityTools: '工具调用',
        capabilityThinking: '思考',
        capabilityCache: '提示缓存',
        capabilityStructured: '结构化输出',
        capabilityVision: '多模态读取',
        lastCall: '上次调用',
        tokens: 'tokens',
        cached: '缓存',
        costUnknown: '费用未知',
        ...
        permissionMode: '工具权限',
        permissionDefault: '按需确认',
        permissionClassifier: '智能判断',
        permissionAuto: '自动执行',
        moreActions: '更多会话操作',
      ...
      commands: {
        ...
        instructions: '查看项目指令',
        skills: '查看可用 Skills',
        mcp: '查看或使用 MCP Resources/Prompts',
        processes: '查看后台进程',
        undo: '撤销最近的文件变更',
        diff: '查看工作区 Diff',
        trace: '查看运行 Trace',
        unknown: '未知命令：{{command}}。输入 /help 查看可用命令。',
        usage: '命令格式不正确。用法：{{usage}}',
        modelUnavailable: '模型“{{model}}”尚未配置，无法切换。',
        noConfiguredModels: '当前没有已配置的模型，请先在环境设置中完成配置。',
      ...
      execution: {
        ...
        subagent: '子代理任务',
        context: '上下文',
        contextHint: '自动压缩阈值 {{threshold}} tokens',
        toolActivity: '工具活动',
      ...
      setup: {
        ...
        restartWorkers: '热更新现有 Worker',
        restartHint: '不中断容器；当前调用结束后，后续调用使用新配置。',
        saving: '正在保存…',
        save: '保存配置',
        savedWithWorkers: '配置已保存，并热更新了 {{count}} 个 Worker',
        saved: '配置已安全保存，新建 Worker 将立即使用',
        workerUpdateFailed: '{{count}} 个 Worker 热更新失败',
        workers: 'Worker',
        workerTitle: '当前 Worker',
        running: '运行中',
        stopped: '已停止',
        noWorkers: '还没有 Worker',
        workspaceModels: '工作区私有配置',
        workspaceModelTitle: '当前工作区模型',
        workspaceModelNotice: '密钥只保存在当前 Worker 数据卷中，删除工作区时一并消失。',
        profileName: '显示名称',
        addWorkspaceModel: '添加工作区模型',
        source: {
          saved: '来源：Gateway 已保存',
          environment: '来源：环境变量',
          none: '来源：未配置'
        }
      },
  ...
  'en-US': {
    translation: {
      ...
      session: {
        ...
        selectConfiguredModel: 'Select model',
        noConfiguredModels: 'No configured models',
        gatewayModels: 'Gateway provided',
        workspaceModels: 'Current workspace',
        capabilities: 'Current model capabilities',
        capabilityTools: 'Tool calling',
        capabilityThinking: 'Thinking',
        capabilityCache: 'Prompt cache',
        capabilityStructured: 'Structured output',
        capabilityVision: 'Multimodal read',
        lastCall: 'Last call',
        tokens: 'tokens',
        cached: 'cached',
        ...
        permissionDefault: 'Ask when needed',
        permissionClassifier: 'Smart approval',
        permissionAuto: 'Run automatically',
      ...
      commands: {
        menu: 'Slash commands',
        open: 'Open slash commands',
        help: 'Show available commands',
        new: 'Create a new session',
        mode: 'Switch Agent mode',
        model: 'Switch the current model',
        think: 'Adjust thinking effort',
        perm: 'Configure tool permissions',
        ...
        mcp: 'Inspect or use MCP resources/prompts',
        ...
        unknown: 'Unknown command: {{command}}. Enter /help to see available commands.',
        usage: 'Invalid command format. Usage: {{usage}}',
        modelUnavailable: 'Model “{{model}}” is not configured and cannot be selected.',
        noConfiguredModels: 'No models are configured. Configure one in Environment first.',
      ...
      execution: {
        ...
        context: 'Context',
        contextHint: 'Automatic compaction at {{threshold}} tokens',
      ...
      setup: {
        ...
        restartWorkers: 'Hot-update existing Workers',
        restartHint: 'No container restart; new calls use the updated configuration.',
        saving: 'Saving…',
        save: 'Save configuration',
        savedWithWorkers: 'Configuration saved and {{count}} Workers updated',
        saved: 'Configuration saved securely; new Workers will use it immediately',
        workerUpdateFailed: '{{count}} Workers failed to update',
        workers: 'Workers',
        workerTitle: 'Current Workers',
        running: 'Running',
        stopped: 'Stopped',
        noWorkers: 'No Workers yet',
        workspaceModels: 'Workspace private configuration',
        workspaceModelTitle: 'Current workspace models',
        workspaceModelNotice: 'Credentials stay in this Worker volume and disappear when the workspace is deleted.',
        profileName: 'Display name',
        addWorkspaceModel: 'Add workspace model',
        source: {
          saved: 'Source: saved by Gateway',
