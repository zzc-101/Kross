...
export const zhCatalog = {
  ...
  'slash.processes.desc': '查看当前会话后台进程',
  ...
  'app.planPaused':
    '计划模式已暂停，等待确认计划。输入 /approve 按计划开发，或 /reject 取消。',
  'app.toolApproved': '已允许一次 {tool}，继续执行。',
  'app.toolRejected': '已拒绝 {tool}，继续让模型调整方案。',
  'app.approvalError': '处理审批时出错：{error}',
  'app.noConductorPlan': '当前没有等待确认的计划。',
  'app.conductorCancelled': '已取消计划。',
  'app.conductorConfirmed': '已确认计划，继续执行。',
  ...
  'cmd.processes.empty': '当前会话没有 managed process。',
  'cmd.processes.header': '当前会话 managed processes：',
...
export const enCatalog: Record<MessageKey, string> = {
  ...
  'slash.processes.desc': 'Show background processes for this session',
  ...
  'app.planPaused':
    'Plan mode paused. Type /approve to implement the plan, or /reject to cancel.',
  ...
  'app.noConductorPlan': 'No plan is waiting for approval.',
  'app.conductorCancelled': 'Plan cancelled.',
  'app.conductorConfirmed': 'Plan confirmed; continuing.',
  'app.runtimeFallback':
  ...
  'cmd.processes.empty': 'This session has no managed processes.',
  'cmd.processes.header': 'Managed processes for this session:',
