...
export const zhCatalog = {
  ...
  'slash.approve.desc': '确认等待中的跨仓库计划',
  'slash.reject.desc': '取消等待中的跨仓库计划',
  ...
  'app.crossRepoPaused':
    '检测到 cross-repo 任务，已在执行前暂停，等待确认计划。输入 /approve 继续，或 /reject 取消。',
  'app.toolApproved': '已允许一次 {tool}，继续执行。',
  'app.toolRejected': '已拒绝 {tool}，继续让模型调整方案。',
  'app.approvalError': '处理审批时出错：{error}',
  'app.noCrossRepoPlan': '当前没有等待确认的 cross-repo 计划。',
  'app.crossRepoCancelled': '已取消 cross-repo 计划。',
  ...
  'cmd.modeUsage': '用法：/mode auto|normal|cross-repo',
  'cmd.modeSwitched': '已切换到 {mode} 模式',
  'cmd.modeUnknown': '未知模式，可选：auto、normal、cross-repo',
...
export const enCatalog: Record<MessageKey, string> = {
  ...
  'slash.approve.desc': 'Approve pending cross-repo plan',
  'slash.reject.desc': 'Reject pending cross-repo plan',
  ...
  'app.crossRepoPaused':
    'Cross-repo task paused for plan approval. Type /approve to continue or /reject to cancel.',
  ...
  'app.noCrossRepoPlan': 'No cross-repo plan is waiting for approval.',
  'app.crossRepoCancelled': 'Cross-repo plan cancelled.',
  'app.crossRepoConfirmed': 'Cross-repo plan confirmed; continuing.',
  'app.runtimeFallback':
  ...
  'cmd.modeUsage': 'Usage: /mode auto|normal|cross-repo',
  'cmd.modeSwitched': 'Switched to {mode} mode',
  'cmd.modeUnknown': 'Unknown mode. Choose: auto, normal, cross-repo',
  'cmd.permUsage':
