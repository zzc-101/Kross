...
export const zhCatalog = {
  ...
  'run.phase.inspect': '正在探索',
  'run.phase.plan': '正在规划',
  'run.phase.act': '正在修改',
  'run.phase.verify': '正在验证',
  'run.phase.review': '正在检查结果',
  'run.phase.complete': '正在收尾',
  'verification.passed': '✓ 验证通过 · {count} 项检查{commands}',
  'verification.failed': '✗ 验证失败 · {count} 项检查{commands}',
  'verification.notRun': '! 未完成验证 · {count} 项检查{commands}',
  'verification.notNeeded': '— 无需验证',
  'mode.auto': '自动',
  'mode.plan': '计划',
  'mode.conductor': '指挥家',
  ...
  'slash.mcp.desc': '查看 MCP Resources/Prompts 或显式使用',
  ...
  'settings.current': '当前',
  'settings.moreAbove': '↑ 还有 {count} 个模型',
  'settings.moreBelow': '↓ 还有 {count} 个模型',
  ...
  'settings.hotkeys': 'N 快捷配置 · ←/→ 分区 · ↑/↓ 选择 · Enter 下一步/应用 · Esc 关闭 · ctrl+p 开关',
  'settings.quick.entry': 'N  快捷配置新模型',
  ...
  'settings.quick.review': '确认配置',
  'settings.quick.empty': '请输入',
  'settings.quick.reuseKey': '沿用已保存密钥',
  'settings.quick.apiKeyHint': '输入会被隐藏；留空可沿用同协议的已保存密钥',
  'settings.quick.contextHint': '填写 token 数，例如 128000 或 256000',
  'settings.quick.invalidBaseUrl': 'Base URL 必须是有效的 http/https 地址',
  'settings.quick.profileNameRequired': '配置名称不能为空',
  'settings.quick.apiKeyRequired': '请输入 API Key，或先保存同协议的凭证',
  'settings.quick.modelRequired': '模型 ID 不能为空',
  'settings.quick.invalidContext': '上下文大小必须是正整数',
  'settings.quick.saved': '已保存并应用 {label}',
  'settings.quick.hotkeys': '输入内容 · Enter 下一步/保存 · Esc 上一步 · 方向键选择协议',
...
export const enCatalog: Record<MessageKey, string> = {
  ...
  'run.phase.inspect': 'Inspecting',
  'run.phase.plan': 'Planning',
  'run.phase.act': 'Applying changes',
  'run.phase.verify': 'Verifying',
  'run.phase.review': 'Reviewing results',
  'run.phase.complete': 'Finishing',
  'verification.passed': '✓ Verification passed · {count} check(s){commands}',
  'verification.failed': '✗ Verification failed · {count} check(s){commands}',
  'verification.notRun': '! Verification not run · {count} check(s){commands}',
  'verification.notNeeded': '— Verification not needed',
  'mode.auto': 'Auto',
  'mode.plan': 'Plan',
  ...
  'slash.mcp.desc': 'Inspect or explicitly use MCP resources/prompts',
  ...
  'settings.moreAbove': '↑ {count} more models',
  'settings.moreBelow': '↓ {count} more models',
  ...
  'settings.hotkeys':
    'N quick setup · ←/→ sections · ↑/↓ select · Enter next/apply · Esc close · ctrl+p toggle',
  'settings.quick.entry': 'N  Quick-configure a new model',
  'settings.quick.title': 'Quick model setup',
  ...
  'settings.quick.review': 'Review configuration',
  'settings.quick.empty': 'Enter a value',
  'settings.quick.reuseKey': 'reuse saved credential',
  'settings.quick.apiKeyHint':
    'Input is masked; leave blank to reuse a saved credential for this protocol',
  'settings.quick.contextHint': 'Token count, for example 128000 or 256000',
  'settings.quick.invalidBaseUrl': 'Base URL must be a valid http/https URL',
  'settings.quick.profileNameRequired': 'Profile name is required',
  'settings.quick.apiKeyRequired':
    'Enter an API key or save credentials for this protocol first',
  'settings.quick.modelRequired': 'Model ID is required',
  'settings.quick.invalidContext': 'Context size must be a positive integer',
  'settings.quick.saved': 'Saved and applied {label}',
  'settings.quick.hotkeys':
    'Type · Enter next/save · Esc back · arrow keys choose protocol',
