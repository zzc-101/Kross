...
const manifestPath = resolve(root, 'core/api-surface.json');
...
const publicSurface = inspectModule('core/src/api/public.ts');
const experimentalSurface = inspectModule('core/src/api/experimental.ts');
const indexSurface = inspectModule('core/src/index.ts');
